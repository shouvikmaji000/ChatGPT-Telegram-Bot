...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5875584706:AAHHwyn_tFBo4o_QkQPixY5DqmdWAN0husA"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Phoenix Chatbot'
username = 'ChatGpt_PhoenixBot'
